<template>
  <div>
    ...
    ></mark>
    <el-input placeholder="选择季度" v-model="showValue" style="width:108px;" @focus="showSeason=true">
...
<script>
  ...
  export default {
    props: {
      ...
      value: {    // 使用model，参数的值就是父组件v-model收到的值。
        type: String,
        default:''
      }
    },
    ...
    methods: {
      ...
      selectSeason(i) {
        ...
        this.showValue = `${this.year}-Q${this.season}`
